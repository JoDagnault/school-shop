...
namespace SchoolShop.Tests.SupplyLists.Large.Infrastructure.Repositories;

[Trait("Size", "Large")]
[Collection("DatabaseBackedTests")]
public sealed class EfSupplyListRepositoryContractTests : SupplyListRepositoryContractTests, IAsyncLifetime
{
    private readonly DatabaseBackedTestFixture _fixture;
    private SchoolShopDbContext? _dbContext;

    public EfSupplyListRepositoryContractTests(DatabaseBackedTestFixture fixture)
    {
        _fixture = fixture;
    }
